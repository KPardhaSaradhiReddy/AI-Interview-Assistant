...
const IntervieweeTab: React.FC = () => {
  ...
  const getCurrentStep = () => {
    ...
    if (currentCandidate.assessmentPhase === 'mcq') return 1;
    if (currentCandidate.assessmentPhase === 'coding') return 2;
    if (currentCandidate.assessmentPhase === 'technical') return 3;
    if (currentCandidate.interviewStatus === 'completed') return 4;
    return 0;
  };
  ...
  const steps = [
    ...
    },
    {
      ...
      description: 'Complete timed multiple-choice questions',
    },
    {
      title: 'Coding Challenge',
      description: 'Solve LeetCode easy problem',
    },
    {
  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      <Card>
        ...
        {getCurrentStep() === 4 && currentCandidate && (
